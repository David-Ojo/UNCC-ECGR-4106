...
epoch_times = []
# Training the model
def train_model(seq_len, hidden_size=64, num_layers=1, epochs=100):
...
output_dir = "problem_1_transformer_results"
os.makedirs(output_dir, exist_ok=True)
results = []

for model_type in ["transformer"]:
    for seq_len in [10, 20, 30]:
        results.append(train_model(seq_len, hidden_size=64, num_layers=1, epochs=100))
